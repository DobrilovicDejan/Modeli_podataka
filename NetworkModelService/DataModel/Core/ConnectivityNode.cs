...
namespace FTN.Services.NetworkModelService.DataModel.Core
{
    public class ConnectivityNode : IdentifiedObject
    {
        ...
        private long connectivitiNodeContainer = 0;
        ...
        public long ConnectivitiNodeContainer { get => connectivitiNodeContainer; set => connectivitiNodeContainer = value; }
        ...
        public override bool Equals(object obj)
        {
            if (base.Equals(obj))
            {
                ...
                return (x.description == this.description &&
                        x.connectivitiNodeContainer == this.connectivitiNodeContainer &&
        ...
        public override bool HasProperty(ModelCode property)
        {
            switch (property)
            {
                ...
                case ModelCode.CONNECTIVITYNODE_CNCONTAINER:
        ...
        public override void GetProperty(Property prop)
        {
            switch (prop.Id)
            {
                ...
                case ModelCode.CONNECTIVITYNODE_CNCONTAINER:
                    prop.SetValue(connectivitiNodeContainer);
                    break;
        ...
        public override void SetProperty(Property property)
        {
            switch (property.Id)
            {
                case ModelCode.CONNECTIVITYNODE_DESCRIPTION:
                    ...
                    break;
                case ModelCode.CONNECTIVITYNODE_CNCONTAINER:
                    connectivitiNodeContainer = property.AsReference();
                    break;
                default:
